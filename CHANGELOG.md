...
> Risoluzione di errori e avvisi di convalida AMO e correzioni di bug per il supporto a Firefox MV3.

### 🐛 Bug Fixes

- fix: resolve AMO validation errors and warnings (eadd09b)
- fix(tests): align test calls with renamed DOM functions (8aa456b)
- fix(messaging): use Promise return in onMessage listener for Firefox MV3 (5bf853e)

### 📚 Documentation

- docs(changelog): add v1.3.0 entry (49b5025)
- docs(readme): add AMO install link and update badges (e7a87e6)

### 🔧 Maintenance

- ci: update badges [skip ci] (752dc5d, a512720, c942718, b9e4651)
- chore: remove AMO_LISTING.md from version control (3c5d6ba)
- ci(amo): add automated AMO publish workflow on tag push (8175c86)
- chore(gitignore): ignore build artifacts (zip, dist/) (f782480)
- style(badges): fix prettier formatting (0bd4e42)
